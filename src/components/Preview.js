    ...
    if (field.toolType === "SINGLE_FIELD") {
        ...
        return (
          <div key={index} className="form-group">
            ...
            <textarea
              ...
              type={field.type}
              readOnly={field.validation.isReadOnly}
        ...
        return (
          <p key={index} className="form-group">
            ...
            <input
              value={field.defaultValue}
              placeholder={field.placeholder}
              className="time_picker form-control"
              type="text"
              readOnly={field.validation.isReadOnly}
              required={field.validation.isRequired}
            />
          ...
          <div>
            {field.checkBoxes.map((checkbox, index) => {
              return (
                <div
                  key={index}
                  className={field.inline ? "form-check-inline" : "form-check"}
                >
                  <input
                    name={checkbox.value}
      ...
      return (
        <div key={index} className="paragraph">
          <label className="label" hidden={field.title === ""}>
            {field.title}
          </label>
          <p
            className="p-2"
          ...
          <div className="row">
            <div className="col-6 m-0">
              ...
              <input
                ...
                className="date_time_picker form-control"
                type="text"
              />
            </div>
            <div className="col-6 m-0">
